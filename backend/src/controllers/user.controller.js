...
export async function getMyFriends(req, res) {
    ...
    try{
        ...
        console.error("Error is getMYFriends cnrolle ",error.message);
...
export async function getMyFriendRequests(req, res) {
    try {
        ...
        console.error('Error while gettng friends reas controller', error.message)
        res.status(500).json({
...
export async function getOutgoingFriendReqs(req,res) {
   ...
   try {
    ...
    console.error('Errro while using geting outing friend res',error.message)
    res.status(500).json({
        message:"Internal server error"
    })
   }
